...
class GameRecord:
    ...
    def __str__(self):
        return (
            ...
            f"There are currently {self.total_copies} total copies of this game in-stock.\n"
            f"The replacement cost for all games is currently {GameRecord.REPLACEMENT_COST}"
        )
